    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
                {formState.id ? "Guardar" : "Crear"} elemento{" "}
            ...
            <div className="mt-6 flex justify-between">
                <button type="button" className="rounded-md px-4 py-2 text-sm border border-accent2 text-accent2" onClick={()=>onDelete(element)}>Eliminar</button>
                <button
                    disabled={loading}
                    type="submit"
